...
| --- | --- | --- |
| Lesson | High-level overview (ipynb slides) | [Here](python-data-viz-intro.ipynb) |
| Practice Activity | Instructor-run lab with exercises | [Here](./practice/python-data-viz-lab.ipynb) |
| Practice Activity | Independent in-class lab | [Here](./practice/viz-exercise.ipynb) |
| Solution  | Solutions to guided exercises. | [Here](./practice/solution-code/python-data-viz-lab-solutions.ipynb) |
| Solution  | Solutions to independent exercises. | [Here](./practice/solution-code/python-data-viz-lab-solutions.ipynb) |
...
|          | Cleveland Heart Data | [Here](./datasets/cleveland_heart_data.csv) |
